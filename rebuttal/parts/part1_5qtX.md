...
- **$O(1)$ in tenant count.** Growing the pool to the memory ceiling moves p50 by at most **+1.29%** relative to $N{=}1000$; on XLM-RoBERTa-XL it is 0.38% *below*, and on ELECTRA −0.16%. There is no upward trend in $N$ in any configuration.
