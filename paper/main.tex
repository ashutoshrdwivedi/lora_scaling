...
\begin{itemize}
  ...
  inference latency: scaling from 100 to 20{,}000 adapters at batch
  size 32 on a single A100-80GB leaves p50 latency flat
  (40.2$\to$40.3~ms) and p99 bounded ($\le$45.7~ms), with serving
  ...
  platforms (Databricks, SageMaker, Modal).
\end{itemize}
